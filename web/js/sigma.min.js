...
function g(){d.nodes=[];d.nodesIndex={};d.edges=[];d.edgesIndex={};return d}sigma.classes.Cascade.call(this);sigma.classes.EventDispatcher.call(this);var d=this;this.p={minNodeSize:0,maxNodeSize:0,minEdgeSize:0,maxEdgeSize:0,scalingMode:"inside",nodesPowRatio:0.5,edgesPowRatio:0};this.borders={};g();
this.addNode=function(a,b){
   if(!d.nodesIndex[a])
{
      //throw Error('Node "'+a+'" already exists.');
   var b=b||{},c={x:0,y:0,size:1,degree:0,inDegree:0,outDegree:0,fixed:!1,active:!1,hidden:!1,forceLabel:!1,label:a.toString(),
id:a.toString(),attr:{}},g;for(g in b)switch(g){case "id":break;case "x":case "y":case "size":c[g]=+b[g];break;case "fixed":case "active":case "hidden":case "forceLabel":c[g]=!!b[g];break;case "color":case "label":c[g]=b[g];break;default:c.attr[g]=b[g]}d.nodes.push(c);d.nodesIndex[a.toString()]=c;return d}};

this.addEdge=function(a,b,c,g){if(d.edgesIndex[a])throw Error('Edge "'+a+'" already exists.');if(!d.nodesIndex[b])throw Error("Edge's source \""+b+'" does not exist yet.');if(!d.nodesIndex[c])throw Error("Edge's target \""+
